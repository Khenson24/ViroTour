 ...
 */
var sharedProps = {
  apiKey:"F74D04D3-A3C6-4381-8480-D423F5259D32",
}
...
export default class ViroSample extends Component {
  ...
  render() {
    ...
    } else if (this.state.navigatorType == CivilRightsAR_NAVIGATOR_TYPE) {
      return this._getCivilNavigator();
    } else if (this.state.navigatorType == AR_NAVIGATOR_TYPE) {
      return this._getARNavigator();
    } else if (this.state.navigatorType == RailroadAR_NAVIGATOR_TYPE) {
      return this._getRailroadNavigator();
    }
  }
  ...
  _getCivilNavigator() {
    return (
      <ViroARSceneNavigator {...this.state.sharedProps}
        initialScene={{scene: CivilRightsARScene}} onExitViro={this._exitViro}/>
    );
  }
